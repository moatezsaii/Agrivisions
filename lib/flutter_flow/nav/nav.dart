...
class AppStateNotifier extends ChangeNotifier {
  AgriVisionFirebaseUser? initialUser;
  AgriVisionFirebaseUser? user;
  ...
  void update(AgriVisionFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'posting',
          path: '/posting',
          builder: (context, params) => PostingWidget(),
        ),
        FFRoute(
          name: 'passwordedit',
          path: '/passwordedit',
          builder: (context, params) => PasswordeditWidget(),
        ),
        FFRoute(
          name: 'editprofile',
          path: '/editprofile',
